...
<div class="All">
  ...
  <div class="form-container">
      <div class="form">
        ...
        <div class="subtitle">Вход в аккаунт</div>
        ...
        <div class="input-container ic2">
          <input id="password" class="input" type="password" v-model="userPassword" placeholder=" " >
        ...
        <span></span>
        <span></span>
        <span></span>Войти</button>
        <div class="reg_text">Нет аккаунта?</div>
        <div class="link" vlink="white"> <a href="/Reg">Зарегистрироваться</a></div>
      </div>
    </div>
  <footer>
